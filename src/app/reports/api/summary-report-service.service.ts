...
export class SummaryReportService {
  ...
  getAllStates() {
    return this.httpClient.get(Constants.HOME_URL + 'getAllStates').toPromise()
  }

  getAllSectorPrograms( areaCode) {
    return this.httpClient.get(Constants.HOME_URL + 'getAllSectorPrograms?stateCode='+areaCode).toPromise()
  }


  getAllTimePeriods(stateId) {
    return this.httpClient.get(Constants.HOME_URL + 'getAllTimePeriods?stateId='+stateId).toPromise()
  }
